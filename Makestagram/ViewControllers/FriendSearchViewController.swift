...
class FriendSearchViewController: UIViewController {
    ...
    /*
        ...
        It is used to update the UI immediately upon user interaction, instead of waiting for a server response.
    */
    ...
    var query: PFQuery? {
        didSet {
            // whenever we assign a new query, cance. any previous requests
            oldValue?.cancel()
        }
    }
    ...
    */
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        // fill the cache of user's followees
