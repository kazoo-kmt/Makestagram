...
class ParseHelper {
    ...
    /**
        ...
        :param: completionBlock The completion block that is called when query completes
    */
    ...
    */
    ...
    /**
        Deltes a follow relationship between two users.
    ...
    */
    ...
    /**
        ...
        LImits thte amount of users returned to 20.
    ...
    */
    ...
    :param: searchText The text that shoudl be used to search for users
    :param: completionBlock The completion block that is called when the query completes
    :return: The generated PFQuery
    */
    static func searchUsers(searchText: String, completionBlock: PFArrayResultBlock) -> PFQuery {
        /*
        Note: We are using a Regex to allow for a case insensitive compare of usernames.
        Regex can e slow on large datasets. For large amount of data it's better to store
        lowercased username in separate column and performa regular string compare.
        */
